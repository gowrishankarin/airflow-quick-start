...
with DAG('dummy', schedule_interval='@daily', default_args=default_args, catchup=False) as dag:
	task_1 = BashOperator(
		task_id='task_1',
		bash_command='exit 0',
		do_xcom_push=False
	...
	no_impact_of_upstream = BashOperator(
		task_id='no_impact_of_upstream',
		bash_command='exit 0',
		do_xcom_push=False,
		trigger_rule="dummy"
	)
	...
	( 
  	...
  	skip_since_all_upstream_succeeded >> no_impact_of_upstream >> [task_8, task_9, wait_and_fail] >> 
